...
export default function Invite({ guest: guestsProps }: Props) {
  ...
  const isConfirmed = (name: string) =>
    guests.members.some((member) => member.name === name && member.is_coming);

  const confirmedCount = () => {
    let count = 0;
    const suffix =
      guests.members.length > 1
        ? "convidados confirmados"
        : "convidado confirmado";
    const mountMessage = (total: number) =>
      `${total} de ${guests.members.length} ${suffix}`;
  ...
  const inviteText =
    guests.members.length > 1
      ...
      : "CONVIDAMOS VOCÊ PARA A CELEBRAÇÃO DO NOSSO";
  const confirmationText =
    guests.members.length > 1
      ? "PEDIMOS QUE CONFIRMEM SUA"
      : "PEDIMOS QUE CONFIRME SUA";
          ...
          <div className="wrapper">
            <div className="confirmation">
              <span className="information">
                Selecione na lista abaixo as pessoas que estarão presentes.
              </span>
              ...
              <div className="actions">
                {guests.confirmed ? null : (
                  <button
                    ...
                    type="button"
                    disabled={guests.absent}
                    onClick={() => setShowConfirmAbsence(!showConfirmAbsence)}
                  >
                ...
                {showConfirmTip && (
                  <div className="confirm-tip">
                    <span className="tip">
                      Primeiro você precisa selecionar quem vai comparecer.
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="info-modal-content normal-height half-width">
                <div className="info">
                  ...
                  <p className="content center">
                    Confirma que não poderá comparecer?
                  </p>
              ...
              <div className="info-modal-content normal-height">
                ...
                <div className="info">
                  ...
                  <p className="content">
                    ...
                    {pixKeyCopied && (
                      <span className="pix-key-copied">Chave copiada!</span>
                    )}
                  </p>
                </div>
              </div>
